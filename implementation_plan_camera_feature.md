...
2. **Detekcja Twarzy w locie:** Użyjemy `react-native-vision-camera-face-detector` w potoku _Frame Processor_. Algorytm będzie wyliczał pozycję czoła (z pozycji oczu).
...
_(Uwaga: `react-native-worklets-core` jest zazwyczaj wymagany do Frame Processors w Vision Camera)_

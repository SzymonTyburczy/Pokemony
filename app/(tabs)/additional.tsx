      ...
      >
        ...
        <View style={styles.rowText}>
          ...
          <Text style={styles.hint}>
            Mocne pociagniecie albo przeciagniecie do konca usuwa z ulubionych
          </Text>
        </View>
      </Pressable>
    </Swipeable>
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Przewijaj w dol, a swipe w lewo usuwa Pokemona z ulubionych.
      </Text>
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>
              Dodaj Pokemony w zakladce Lista i wroc tutaj.
            </Text>
            <Pressable

...
import {
  usePokemonCryPlayer,
  getCryPlayerHtml,
} from "../../src/features/pokemon/hooks/usePokemonCryPlayer";
        ...
        return (
          ...
          >
            {imageUri ? (
              ...
              <View
                style={[
                  styles.customItemImage,
                  styles.customItemImagePlaceholder,
                ]}
              >
            ...
            <View style={styles.customItemInfo}>
              <Text style={styles.customItemName}>
                {formatPokemonName(p.name)}
              </Text>
              {p.types.length > 0 && (
                <Text style={styles.customItemTypes}>
                  {p.types.join(" / ")}
                </Text>
              )}
            </View>
...
const ListScreen = () => {
  ...
  const handleOpenCustomPokemon = useCallback(
    (id: string) => {
